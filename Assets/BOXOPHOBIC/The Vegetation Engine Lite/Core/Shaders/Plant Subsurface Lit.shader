	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 appendResult7736_g80226 = (float3(v.vertex.xyz.x , 0.0 , v.vertex.xyz.z));
				...
				half3 VertexPos40_g80256 = temp_output_7738_0_g80226;
				half3 VertexPos40_g80257 = VertexPos40_g80256;
				float3 appendResult74_g80257 = (float3(VertexPos40_g80257.x , 0.0 , 0.0));
				half3 VertexPosRotationAxis50_g80257 = appendResult74_g80257;
				float3 break84_g80257 = VertexPos40_g80257;
				float3 appendResult81_g80257 = (float3(0.0 , break84_g80257.y , break84_g80257.z));
				half3 VertexPosOtherAxis82_g80257 = appendResult81_g80257;
				float3 ase_worldPos = TransformObjectToWorld( (v.vertex).xyz );
				float3 vertexToFrag3890_g80226 = ase_worldPos;
				float3 WorldPosition3905_g80226 = vertexToFrag3890_g80226;
				float4x4 break19_g80288 = GetObjectToWorldMatrix();
				float3 appendResult20_g80288 = (float3(break19_g80288[ 0 ][ 3 ] , break19_g80288[ 1 ][ 3 ] , break19_g80288[ 2 ][ 3 ]));
				float3 temp_output_122_0_g80288 = Mesh_PivotsData7725_g80226;
				float3 PivotsOnly105_g80288 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g80288 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g80290 = ( appendResult20_g80288 + PivotsOnly105_g80288 );
				half3 WorldData19_g80290 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g80290 = WorldData19_g80290;
				#else
				float3 staticSwitch14_g80290 = ObjectData20_g80290;
				#endif
				float3 temp_output_114_0_g80288 = staticSwitch14_g80290;
				float3 vertexToFrag4224_g80226 = temp_output_114_0_g80288;
				...
				half3 Input_Position419_g80241 = Motion_10_Position7745_g80226;
				float Input_MotionScale287_g80241 = ( _MotionScale_10 + 0.2 );
				half NoiseTex_Tilling735_g80241 = TVE_NoiseTexTilling;
				float2 temp_output_597_0_g80241 = (( Input_Position419_g80241 * Input_MotionScale287_g80241 * NoiseTex_Tilling735_g80241 * 0.0075 )).xz;
				float2 temp_output_447_0_g80303 = ((TVE_MotionParams).xy*2.0 + -1.0);
				half2 Global_Wind_DirectionWS4683_g80226 = temp_output_447_0_g80303;
				half2 Input_DirectionWS423_g80241 = Global_Wind_DirectionWS4683_g80226;
				float lerpResult128_g80242 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g80241 = _MotionSpeed_10;
				half Input_MotionVariation284_g80241 = _MotionVariation_10;
				half3 Input_Position167_g80279 = ObjectPosition4223_g80226;
				float dotResult156_g80279 = dot( (Input_Position167_g80279).xz , float2( 12.9898,78.233 ) );
				half Input_DynamicMode120_g80279 = 0.0;
				float Postion_Random162_g80279 = ( sin( dotResult156_g80279 ) * ( 1.0 - Input_DynamicMode120_g80279 ) );
				float4 break33_g80299 = _motion_variation_mode;
				float temp_output_30_0_g80299 = ( v.ase_color.r * break33_g80299.x );
				float temp_output_29_0_g80299 = ( v.ase_color.g * break33_g80299.y );
				float temp_output_31_0_g80299 = ( v.ase_color.b * break33_g80299.z );
				float lerpResult7828_g80226 = lerp( 0.0 , ( temp_output_30_0_g80299 + temp_output_29_0_g80299 + temp_output_31_0_g80299 + ( v.ase_color.a * break33_g80299.w ) ) , saturate( _MotionVariationMode ));
				float Mesh_Variation16_g80226 = lerpResult7828_g80226;
				half Input_Variation124_g80279 = Mesh_Variation16_g80226;
				half ObjectData20_g80281 = frac( ( Postion_Random162_g80279 + Input_Variation124_g80279 ) );
				half WorldData19_g80281 = Input_Variation124_g80279;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g80281 = WorldData19_g80281;
				#else
				float staticSwitch14_g80281 = ObjectData20_g80281;
				#endif
				float temp_output_112_0_g80279 = staticSwitch14_g80281;
				float clampResult171_g80279 = clamp( temp_output_112_0_g80279 , 0.01 , 0.99 );
				float Global_MeshVariation7760_g80226 = clampResult171_g80279;
				half Input_GlobalMeshVariation569_g80241 = Global_MeshVariation7760_g80226;
				float temp_output_630_0_g80241 = ( ( ( lerpResult128_g80242 * Input_MotionSpeed62_g80241 ) + ( Input_MotionVariation284_g80241 * Input_GlobalMeshVariation569_g80241 ) ) * 0.03 );
				float temp_output_607_0_g80241 = frac( temp_output_630_0_g80241 );
				float4 lerpResult590_g80241 = lerp( SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g80241 + ( -Input_DirectionWS423_g80241 * temp_output_607_0_g80241 ) ), 0.0 ) , SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g80241 + ( -Input_DirectionWS423_g80241 * frac( ( temp_output_630_0_g80241 + 0.5 ) ) ) ), 0.0 ) , ( abs( ( temp_output_607_0_g80241 - 0.5 ) ) / 0.5 ));
				half4 Noise_Complex703_g80241 = lerpResult590_g80241;
				float2 temp_output_645_0_g80241 = ((Noise_Complex703_g80241).rg*2.0 + -1.0);
				float2 break650_g80241 = temp_output_645_0_g80241;
				float3 appendResult649_g80241 = (float3(break650_g80241.x , 0.0 , break650_g80241.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Global_Noise_OS5548_g80226 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g80241 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g80271 = Global_Noise_OS5548_g80226;
				float2 break448_g80303 = temp_output_447_0_g80303;
				float3 appendResult452_g80303 = (float3(break448_g80303.x , 0.0 , break448_g80303.y));
				half2 Global_Wind_DirectionOS5692_g80226 = (( mul( GetWorldToObjectMatrix(), float4( appendResult452_g80303 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Wind_DirectionOS458_g80271 = Global_Wind_DirectionOS5692_g80226;
				float4 break322_g80303 = TVE_MotionParams;
				float lerpResult457_g80303 = lerp( break322_g80303.z , TVE_WindEditor.z , TVE_WindEditor.w);
				float temp_output_459_0_g80303 = ( 1.0 - lerpResult457_g80303 );
				half Global_Wind_Power2223_g80226 = ( 1.0 - ( temp_output_459_0_g80303 * temp_output_459_0_g80303 ) );
				half Input_WindPower449_g80271 = Global_Wind_Power2223_g80226;
				float2 lerpResult516_g80271 = lerp( Input_Noise_DirectionOS487_g80271 , Input_Wind_DirectionOS458_g80271 , ( Input_WindPower449_g80271 * 0.6 ));
				half Mesh_Height1524_g80226 = saturate( ( v.vertex.xyz.y / _BoundsHeightValue ) );
				half Input_MeshHeight388_g80271 = Mesh_Height1524_g80226;
				half ObjectData20_g80272 = Input_MeshHeight388_g80271;
				half Input_BoundsHeight390_g80271 = 1.0;
				half WorldData19_g80272 = ( Input_MeshHeight388_g80271 * Input_MeshHeight388_g80271 * Input_BoundsHeight390_g80271 );
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g80272 = WorldData19_g80272;
				#else
				float staticSwitch14_g80272 = ObjectData20_g80272;
				#endif
				half Final_Motion10_Mask321_g80271 = ( staticSwitch14_g80272 * 2.0 );
				half Input_BendingAmplitude376_g80271 = _MotionAmplitude_10;
				half Global_MotionValue640_g80271 = TVE_MotionValue_10;
				half2 Final_Bending631_g80271 = ( lerpResult516_g80271 * ( Final_Motion10_Mask321_g80271 * Input_BendingAmplitude376_g80271 * Input_WindPower449_g80271 * Input_WindPower449_g80271 * Global_MotionValue640_g80271 ) );
				float2 break636_g80271 = Final_Bending631_g80271;
				float3 appendResult637_g80271 = (float3(break636_g80271.x , 0.0 , break636_g80271.y));
				half3 Motion_10_Bending216_g80226 = appendResult637_g80271;
				half3 Angle44_g80256 = Motion_10_Bending216_g80226;
				half Angle44_g80257 = (Angle44_g80256).z;
				half3 VertexPos40_g80258 = ( VertexPosRotationAxis50_g80257 + ( VertexPosOtherAxis82_g80257 * cos( Angle44_g80257 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g80257 ) * sin( Angle44_g80257 ) ) );
				float3 appendResult74_g80258 = (float3(0.0 , 0.0 , VertexPos40_g80258.z));
				half3 VertexPosRotationAxis50_g80258 = appendResult74_g80258;
				float3 break84_g80258 = VertexPos40_g80258;
				float3 appendResult81_g80258 = (float3(break84_g80258.x , break84_g80258.y , 0.0));
				half3 VertexPosOtherAxis82_g80258 = appendResult81_g80258;
				half Angle44_g80258 = -(Angle44_g80256).x;
				half3 Input_Position419_g80286 = WorldPosition3905_g80226;
				float3 break459_g80286 = Input_Position419_g80286;
				float Sum_Position446_g80286 = ( break459_g80286.x + break459_g80286.y + break459_g80286.z );
				half Input_MotionScale321_g80286 = ( _MotionScale_20 * 0.1 );
				half Input_MotionVariation330_g80286 = _MotionVariation_20;
				half Input_GlobalVariation400_g80286 = Global_MeshVariation7760_g80226;
				float lerpResult128_g80287 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g80286 = _MotionSpeed_20;
				float temp_output_404_0_g80286 = ( lerpResult128_g80287 * Input_MotionSpeed62_g80286 );
				half Motion_SineA450_g80286 = sin( ( ( Sum_Position446_g80286 * Input_MotionScale321_g80286 ) + ( Input_MotionVariation330_g80286 * Input_GlobalVariation400_g80286 ) + temp_output_404_0_g80286 ) );
				half Motion_SineB395_g80286 = sin( ( ( temp_output_404_0_g80286 * 0.6842 ) + ( Sum_Position446_g80286 * Input_MotionScale321_g80286 ) ) );
				half3 Input_Position419_g80269 = VertexPosition3588_g80226;
				float3 normalizeResult518_g80269 = normalize( Input_Position419_g80269 );
				half2 Input_DirectionOS423_g80269 = Global_Wind_DirectionOS5692_g80226;
				float2 break521_g80269 = -Input_DirectionOS423_g80269;
				float3 appendResult522_g80269 = (float3(break521_g80269.x , 0.0 , break521_g80269.y));
				float dotResult519_g80269 = dot( normalizeResult518_g80269 , appendResult522_g80269 );
				half Input_Value62_g80269 = _MotionFacingValue;
				float lerpResult524_g80269 = lerp( 1.0 , (dotResult519_g80269*0.5 + 0.5) , Input_Value62_g80269);
				half ObjectData20_g80270 = max( lerpResult524_g80269 , 0.001 );
				half WorldData19_g80270 = 1.0;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g80270 = WorldData19_g80270;
				#else
				float staticSwitch14_g80270 = ObjectData20_g80270;
				#endif
				half Motion_FacingMask7691_g80226 = staticSwitch14_g80270;
				half Motion_20_Amplitude7628_g80226 = Motion_FacingMask7691_g80226;
				half Input_MotionAmplitude384_g80286 = Motion_20_Amplitude7628_g80226;
				half Input_GlobalWind407_g80286 = Global_Wind_Power2223_g80226;
				float4 break638_g80241 = abs( Noise_Complex703_g80241 );
				half Global_Noise_B5526_g80226 = break638_g80241.b;
				half Input_GlobalNoise411_g80286 = Global_Noise_B5526_g80226;
				float lerpResult413_g80286 = lerp( 1.8 , 0.4 , Input_GlobalWind407_g80286);
				half Motion_Amplitude418_g80286 = ( Input_MotionAmplitude384_g80286 * Input_GlobalWind407_g80286 * pow( Input_GlobalNoise411_g80286 , lerpResult413_g80286 ) );
				half Input_Squash58_g80286 = _MotionAmplitude_20;
				float3 appendResult7790_g80226 = (float3(0.0 , v.vertex.xyz.y , 0.0));
				half Mesh_Spherical7697_g80226 = saturate( ( distance( v.vertex.xyz , appendResult7790_g80226 ) / _BoundsRadiusValue ) );
				float4 break33_g80298 = _motion_mask_mode_20;
				float temp_output_30_0_g80298 = ( v.ase_color.r * break33_g80298.x );
				float temp_output_29_0_g80298 = ( v.ase_color.g * break33_g80298.y );
				float temp_output_31_0_g80298 = ( v.ase_color.b * break33_g80298.z );
				float lerpResult7813_g80226 = lerp( Mesh_Spherical7697_g80226 , ( temp_output_30_0_g80298 + temp_output_29_0_g80298 + temp_output_31_0_g80298 + ( v.ase_color.a * break33_g80298.w ) ) , saturate( _MotionMaskMode_20 ));
				half Mesh_Motion_207834_g80226 = lerpResult7813_g80226;
				half Input_MeshMotion_20388_g80286 = Mesh_Motion_207834_g80226;
				half Input_BoundsRadius390_g80286 = 1.0;
				half Global_MotionValue462_g80286 = TVE_MotionValue_20;
				half2 Input_DirectionOS366_g80286 = Global_Wind_DirectionOS5692_g80226;
				float2 break371_g80286 = Input_DirectionOS366_g80286;
				float3 appendResult372_g80286 = (float3(break371_g80286.x , ( Motion_SineA450_g80286 * 0.3 ) , break371_g80286.y));
				half3 Motion_20_Squash7632_g80226 = ( ( (max( Motion_SineA450_g80286 , Motion_SineB395_g80286 )*0.5 + 0.5) * Motion_Amplitude418_g80286 * Input_Squash58_g80286 * Input_MeshMotion_20388_g80286 * Input_BoundsRadius390_g80286 * Global_MotionValue462_g80286 ) * appendResult372_g80286 );
				half3 VertexPos40_g80245 = ( ( VertexPosRotationAxis50_g80258 + ( VertexPosOtherAxis82_g80258 * cos( Angle44_g80258 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g80258 ) * sin( Angle44_g80258 ) ) ) + Motion_20_Squash7632_g80226 );
				float3 appendResult74_g80245 = (float3(0.0 , VertexPos40_g80245.y , 0.0));
				float3 VertexPosRotationAxis50_g80245 = appendResult74_g80245;
				float3 break84_g80245 = VertexPos40_g80245;
				float3 appendResult81_g80245 = (float3(break84_g80245.x , 0.0 , break84_g80245.z));
				float3 VertexPosOtherAxis82_g80245 = appendResult81_g80245;
				half Input_Rolling379_g80286 = _MotionAmplitude_22;
				half Motion_20_Rolling7633_g80226 = ( Motion_SineA450_g80286 * Motion_Amplitude418_g80286 * Input_Rolling379_g80286 * Input_MeshMotion_20388_g80286 * Global_MotionValue462_g80286 );
				half Angle44_g80245 = Motion_20_Rolling7633_g80226;
				half3 Input_Position500_g80250 = WorldPosition3905_g80226;
				half Input_MotionScale321_g80250 = _MotionScale_32;
				half Input_MotionVariation330_g80250 = _MotionVariation_32;
				half Input_GlobalVariation372_g80250 = Global_MeshVariation7760_g80226;
				float lerpResult128_g80251 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g80250 = _MotionSpeed_32;
				float4 tex2DNode460_g80250 = SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( ( (Input_Position500_g80250).xz * Input_MotionScale321_g80250 * 0.03 ) + ( Input_MotionVariation330_g80250 * Input_GlobalVariation372_g80250 ) + ( lerpResult128_g80251 * Input_MotionSpeed62_g80250 * 0.02 ) ), 0.0 );
				float3 appendResult462_g80250 = (float3(tex2DNode460_g80250.r , tex2DNode460_g80250.g , tex2DNode460_g80250.b));
				half3 Flutter_Texture489_g80250 = (appendResult462_g80250*2.0 + -1.0);
				half Motion_30_Amplitude7534_g80226 = ( _MotionAmplitude_32 * Motion_FacingMask7691_g80226 );
				half Input_MotionAmplitude58_g80250 = Motion_30_Amplitude7534_g80226;
				float4 break33_g80297 = _motion_mask_mode_30;
				float temp_output_30_0_g80297 = ( v.ase_color.r * break33_g80297.x );
				float temp_output_29_0_g80297 = ( v.ase_color.g * break33_g80297.y );
				float temp_output_31_0_g80297 = ( v.ase_color.b * break33_g80297.z );
				float lerpResult7820_g80226 = lerp( v.texcoord.y , ( temp_output_30_0_g80297 + temp_output_29_0_g80297 + temp_output_31_0_g80297 + ( v.ase_color.a * break33_g80297.w ) ) , saturate( _MotionMaskMode_30 ));
				half Mesh_Motion_30144_g80226 = lerpResult7820_g80226;
				half Input_MeshMotion_30374_g80250 = Mesh_Motion_30144_g80226;
				half Input_GlobalWind471_g80250 = Global_Wind_Power2223_g80226;
				half Global_MotionValue503_g80250 = TVE_MotionValue_30;
				half Input_GlobalNoise472_g80250 = Global_Noise_B5526_g80226;
				float lerpResult466_g80250 = lerp( 2.4 , 0.6 , Input_GlobalWind471_g80250);
				half Flutter_Amplitude491_g80250 = ( Input_MotionAmplitude58_g80250 * Input_MeshMotion_30374_g80250 * Input_GlobalWind471_g80250 * Global_MotionValue503_g80250 * pow( Input_GlobalNoise472_g80250 , lerpResult466_g80250 ) );
				half3 Motion_30_Flutter263_g80226 = ( Flutter_Texture489_g80250 * Flutter_Amplitude491_g80250 );
				float3 Vertex_Motion_Object7655_g80226 = ( ( ( VertexPosRotationAxis50_g80245 + ( VertexPosOtherAxis82_g80245 * cos( Angle44_g80245 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g80245 ) * sin( Angle44_g80245 ) ) ) + Motion_30_Flutter263_g80226 ) + Mesh_PivotsOS7730_g80226 );
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float temp_output_7_0_g80294 = _GradientMinValue;
				float temp_output_10_0_g80294 = ( _GradientMaxValue - temp_output_7_0_g80294 );
				half Gradient_Value2784_g80226 = saturate( ( ( Mesh_Height1524_g80226 - temp_output_7_0_g80294 ) / ( temp_output_10_0_g80294 + 0.0001 ) ) );
				float3 lerpResult2779_g80226 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , Gradient_Value2784_g80226);
				float clampResult17_g80232 = clamp( Main_Mask57_g80226 , 0.0001 , 0.9999 );
				float temp_output_7_0_g80233 = _MainMaskMinValue;
				float temp_output_10_0_g80233 = ( _MainMaskMaxValue - temp_output_7_0_g80233 );
				half Main_Mask_Remap5765_g80226 = saturate( ( ( clampResult17_g80232 - temp_output_7_0_g80233 ) / ( temp_output_10_0_g80233 + 0.0001 ) ) );
				float clampResult17_g80231 = clamp( Second_Mask81_g80226 , 0.0001 , 0.9999 );
				float temp_output_7_0_g80234 = _SecondMaskMinValue;
				float temp_output_10_0_g80234 = ( _SecondMaskMaxValue - temp_output_7_0_g80234 );
				half Second_Mask_Remap6130_g80226 = saturate( ( ( clampResult17_g80231 - temp_output_7_0_g80234 ) / ( temp_output_10_0_g80234 + 0.0001 ) ) );
				...
				float3 temp_cast_3 = (( 0.04 * Render_Specular4861_g80226 )).xxx;
				...
				half3 Subsurface_Color1722_g80226 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Tinted2808_g80226 );
				half Subsurface_Intensity1752_g80226 = _SubsurfaceValue;
				half Subsurface_Mask1557_g80226 = Blend_Mask_Remap6621_g80226;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float temp_output_29_0_g80297 = ( v.ase_color.g * break33_g80297.y );
				float temp_output_31_0_g80297 = ( v.ase_color.b * break33_g80297.z );
				float lerpResult7820_g80226 = lerp( v.ase_texcoord.y , ( temp_output_30_0_g80297 + temp_output_29_0_g80297 + temp_output_31_0_g80297 + ( v.ase_color.a * break33_g80297.w ) ) , saturate( _MotionMaskMode_30 ));
				half Mesh_Motion_30144_g80226 = lerpResult7820_g80226;
				half Input_MeshMotion_30374_g80250 = Mesh_Motion_30144_g80226;
				half Input_GlobalWind471_g80250 = Global_Wind_Power2223_g80226;
				half Global_MotionValue503_g80250 = TVE_MotionValue_30;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_29_0_g80297 = ( v.ase_color.g * break33_g80297.y );
				float temp_output_31_0_g80297 = ( v.ase_color.b * break33_g80297.z );
				float lerpResult7820_g80226 = lerp( v.texcoord0.y , ( temp_output_30_0_g80297 + temp_output_29_0_g80297 + temp_output_31_0_g80297 + ( v.ase_color.a * break33_g80297.w ) ) , saturate( _MotionMaskMode_30 ));
				half Mesh_Motion_30144_g80226 = lerpResult7820_g80226;
				half Input_MeshMotion_30374_g80250 = Mesh_Motion_30144_g80226;
				half Input_GlobalWind471_g80250 = Global_Wind_Power2223_g80226;
				half Global_MotionValue503_g80250 = TVE_MotionValue_30;
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.RangedFloatNode;1355;-1408,-640;Half;False;Property;_render_coverage;_render_coverage;175;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-1808,-640;Half;False;Property;_render_dst;_render_dst;173;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1632,-640;Half;False;Property;_render_zw;_render_zw;174;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-2000,-640;Half;False;Property;_render_src;_render_src;172;1;[HideInInspector];Create;True;0;0;0;True;0;False;5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-2176,-640;Half;False;Property;_render_cull;_render_cull;171;1;[HideInInspector];Create;True;0;3;Both;0;Back;1;Front;2;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;471;-1664,640;Inherit;False;Define ShaderType Plant;178;;76907;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2138;-1152,-256;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2139;-1152,-256;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.FunctionNode;2127;-2175,-256;Inherit;False;Base Lite;0;;80226;1f5c35e7b395a0a498f1140933e5e744;36,3880,1,4179,1,6791,1,1298,1,6792,1,1300,1,7741,1,6116,1,7558,1,1718,1,1717,1,1715,1,6729,1,1776,1,7611,0,3501,1,2807,1,6206,1,6320,1,6166,1,4837,1,6848,1,6161,1,6622,1,1737,1,1736,1,1734,1,1735,1,7560,1,7660,1,7656,1,7653,1,7652,1,7693,1,7737,1,5090,1;2;6205;FLOAT;1;False;6198;FLOAT;1;False;18;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;1235;FLOAT;532;FLOAT;5389;FLOAT;721;FLOAT3;1230;FLOAT;5296;FLOAT;1461;FLOAT;1290;FLOAT;4867;FLOAT3;534
...
Node;AmplifyShaderEditor.FunctionNode;2104;-1936,640;Inherit;False;Define Lighting Subsurface;176;;80306;77137addbb4a22f4c818adc8782926be;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=10AE8FD6F5F781910BF988AED6771DD23E3834F6